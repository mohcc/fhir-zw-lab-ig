...
## ValueSet: ZW Specimen Rejection Reasons 

| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/lab/ValueSet/zw-rejection-reasons | *Version*:0.1.0 |
| Active as of 2026-06-11 | *Computable Name*:VSZWRejectionReasons |

 
Value set of specimen rejection reasons (ZW.LAB.A.DE88). 
...
```json
{
  ...
  "url" : "http://mohcc.gov.zw/fhir/lab/ValueSet/zw-rejection-reasons",
  "version" : "0.1.0",
  "name" : "VSZWRejectionReasons",
  ...
  "compose" : {
    "include" : [{
      "system" : "http://mohcc.gov.zw/fhir/lab/CodeSystem/zw-rejection-reasons"
    }]
  }
}
